...
def delete_record(name,p):
    ...
    if((name,p) in s):
        ...
        message="Product Name and ID do not match"
    return message
def unpack():
    global array
    ele=0
...
def search_page():
    ...
    if(request.method=='POST'):
        ...
        if(result==-1):
            ...
            message='Product not present in the Inventory'
            return render_template('search.html',message=message)
        else:
            
            res=ssearch(skey)
         
            message='Product present in the Inventory,The products are:'
...
def listmethod():
        if(request.method=='POST'):
            ...
            if(result==True):
                ...
                message = "Product added Sucessfulyy"
                
            else:
                message = "Product ID cant be repeated."
                arrayOfproducts=unpack()
